...
if __name__ == '__main__':
      with suppress(KeyboardInterrupt):
          with suppress(IndexError):
              ...
              logger.info(
                  f"{bcolors.OKRED}Attack Started to{bcolors.OKBLUE} %s{bcolors.OKRED} with{bcolors.OKBLUE} %s{bcolors.OKRED} method for{bcolors.OKBLUE} %s{bcolors.OKRED} seconds, threads:{bcolors.OKBLUE} %d{bcolors.OKRED}!{bcolors.RESET}"
